...
const PageLayout = ({ children, title, actions, maxWidth = 'lg', titleImage }) => (
  <Box sx={{
    width: '100%',
    ...
    <Box sx={{ width: '100%', maxWidth: '100%' }}>
      <Paper elevation={2} sx={{
        ...
        <Typography
          ...
          sx={{ fontWeight: 600, color: 'white', display: 'flex', alignItems: 'center', gap: 1, fontSize: { xs: '1.5rem', sm: '2rem', md: '2.5rem' } }}
        >
          {titleImage && (
            <Avatar
              src={titleImage}
